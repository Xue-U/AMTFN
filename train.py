...
for epoch in range(10):
    ...
    acc_score_train, recall_score_train, precision_train, F1_score_train, train_auc, _, _ ,_,_= Evaluation_index(
    ...
    # acc_score_test, recall_score_test, precision_test, F1_score_test, test_auc, mcc_test, sn_test, fpr, tpr = Evaluation_index(
    #     predict_score_val_all, y_pred_val_all, label_val_all)
    acc_score_val, recall_score_val, precision_val, F1_score_val, val_auc, mcc_val, sn_val,fpr, tpr = Evaluation_index(
        predict_score_val_all, y_pred_val_all, label_val_all)
